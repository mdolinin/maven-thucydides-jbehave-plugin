...
//                        addGetValueFromVariable(codeModel, serviceStepsRawClass, whenMethod, whenMethod.body(), parameterClass, modelParameterClass, parameterName, parameterKeyName);
                        addInitParam(codeModel, serviceStepsRawClass, whenMethod, jConditional._then(), parameterClass, modelParameterClass, parameterName, parameterKeyName, declaration);
    ...
    public static void addInitParam(JCodeModel codeModel, JDefinedClass serviceStepsRawClass, JMethod method, JBlock jBlock, Class<?> parameterClass, JClass rawParameterType, String parameterName, String parameterKeyName, JVar declaration) {
        String typeName = rawParameterType.name();
        if (typeName.equals(Boolean.class.getSimpleName())) {
